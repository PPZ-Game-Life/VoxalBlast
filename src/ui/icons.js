...
const paths = {
  ...
  hammer: '<path fill="#ffca52" d="m6 3 6 2 5 5-4 4-5-5-4-1z"/><path d="m12 13-7 8-3-3 7-8"/>',
  rocket: '<path fill="#ffca52" d="M9 15C8 9 13 3 21 3c0 8-6 13-12 12Z"/><circle cx="16" cy="8" r="2" fill="white"/><path d="m9 8-5 1-2 5 6-1m8 1-1 6-5 2 1-6M6 17l-3 4"/>',
  bomb: '<circle cx="11" cy="14" r="7" fill="#597cbb"/><path d="m14 7 2-3h3m0-3v3m2 1-2-1M7 12l2-2"/>',
  settings: '<path d="m10 2-1 3-3 1-3-1-2 4 2 2v3l-2 2 2 4 3-1 3 1 1 3h4l1-3 3-1 3 1 2-4-2-2v-3l2-2-2-4-3 1-3-1-1-3z" transform="translate(1 0) scale(.9)"/><circle cx="12" cy="11.5" r="3" fill="white"/>',
