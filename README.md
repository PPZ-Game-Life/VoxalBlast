...
当前版本 **0.8.0**：「木质田园」品质升级——5×5×5 外壳由 **98 个唯一方块**组成，六面 150 个表面格共享棱角实体；原木与彩漆分开处理，配合 HDR 环境反射、统一 ACES 色调映射、绘本田园背景和奶油纸木框 HUD。规则、计分与存档格式自 v0.5.0 起未变。
...
- 本轮验证记录：[v0.8.0 渲染品质改版验收](docs/Planning/04-MVP验收清单.md)；旧版记录保留为历史，不代替本轮视觉验证。
