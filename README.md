...
> 当前实现基线：**v0.9.1**（`package.json`）。本轮是发牌机制与渐进难度（P1），见 [发牌与渐进难度 P1 实现记录](docs/Technical/DEALING_P1.md)；上一轮的视觉参数见 [截图参考美术实现](docs/Technical/REFERENCE_ART_SKIN.md)。不代表远端部署版本。
